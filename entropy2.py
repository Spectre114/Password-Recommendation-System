...
# Plot the curve
plt.plot(x_sorted, y_sorted, "o", color='black', markersize=6)

# Set the labels and title
plt.xlabel('Probability of $Easy_{\u0075\u0073\u0065\u0072}$ (α)',fontsize=12)
plt.ylabel('Entropy of probabilty [H(α)]',fontsize=12)
plt.title('$Probability_{\u0045\u0061\u0073\u0079}$ Curve')
...
# Set the labels and title
plt.xlabel('Probability of $Moderate_{\u0075\u0073\u0065\u0072}$ (α)',fontsize=12)
plt.ylabel('Entropy of probabilty [H(α)]',fontsize=12)
plt.title('$Probability_{\u004D\u006F\u0064\u0065\u0072\u0061\u0074\u0065}$ Curve')
...
# Set the labels and title
plt.xlabel('Probability of $Hard_{\u0075\u0073\u0065\u0072}$ (α)',fontsize=12)
plt.ylabel('Entropy of probabilty [H(α)]',fontsize=12)
plt.title('$Probability_{\u0048\u0061\u0072\u0064}$ Curve')
